  ...
  return (
    <div className="h-screen w-screen">
      ...
      <div className={'flex sm:flex-row flex-col'}>
        <div className={'sm:hidden inline-block justify-center items-center flex'}>
        ...
        <div className={'h-screen w-screen sm:w-1/2'}>
          ...
          <div className={'flex flex-row mt-5 sm:ml-36 ml-10'}>
            <button className={'bg_blue py-1 px-6 rounded-full text-white body-lite m-1 w-32 hover:bg-black'}>#HTML</button>
            <button className={'bg_green py-1 px-6 rounded-full text-white body-lite m-1 w-32 hover:bg-black'}>#CSS</button>
            <button className={'bg_pink py-1 px-6 rounded-full text-white body-lite m-1 w-32 hover:bg-black'}>#C</button>
          </div>
          <div className={'flex flex-row mt-1 sm:ml-36 ml-10'}>
            <button className={'bg_purple py-1 px-6 rounded-full text-white body-lite m-1 w-32 hover:bg-black'}>#React</button>
            <button className={'bg_blue2 py-1 px-6 rounded-full text-white body-lite m-1 w-32 hover:bg-black'}>#JavaScript</button>
            <button className={'bg_blue py-1 px-6 rounded-full text-white body-lite m-1 w-32 hover:bg-black'}>#Node.js</button>
          </div>
        ...
        <div className={'hidden sm:inline-block h-screen w-1/2 border border-black'}>
